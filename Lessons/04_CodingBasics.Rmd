...
vector1[3] # give the third item in vector 1

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # default bycolumn
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) # byrow
matrix2
...
list1[[2]] #To get elements from a matrix in a list, list1[[3]][c(1,2)]
