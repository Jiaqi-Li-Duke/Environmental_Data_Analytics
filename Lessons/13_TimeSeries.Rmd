...
TempTest.auto <- lme(data = PeterPaul.summertemp,
                     ...
                     random = ~1|Week)
TempTest.auto # Week as random effect: what is the variance of the weeks

ACF(TempTest.auto) # 0.42324818， which means 42% 
...
TempTest.mixed <- lme(data = PeterPaul.summertemp,
                     ...
                     method = "REML")
summary(TempTest.mixed) # The stdDev is sligtly lower than the previous model; the temperature increases by 0.0001*365*20 in 20 years
